...
const intervalfunc = (chatId, month, day, whom, name, add) => {
    ...
    const timed = new Date(2022, 02, 13, 13, 50).getTime();
    let endDate = timed - time < 0 ? new Date(year+1, month, day, 08).getTime() : new Date(2022, 02, 13, 13, 50, 10).getTime();
